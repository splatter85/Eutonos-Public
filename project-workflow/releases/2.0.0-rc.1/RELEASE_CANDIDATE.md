...
- `TOVA7.7_RELEASE_CHECK.json` records exact source-to-starter mirror parity, starter owner validation, preservation hashes, retired live paths, required scripts, and the full starter payload checksum result.
...
- Decide whether to publish `2.0.0-rc.1` or request another revision.
